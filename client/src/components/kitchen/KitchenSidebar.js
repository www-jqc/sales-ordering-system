...
import { FaTachometerAlt, FaClipboardList, FaCogs, FaSignOutAlt, FaUtensils } from 'react-icons/fa';
import { useAuth } from '../../contexts/AuthContext';
import { useNavigate } from 'react-router-dom';

const KitchenSidebar = ({ activeComponent, setActiveComponent }) => {
  ...
  const menuItems = [
    { id: 'dashboard', label: 'Order Dashboard', icon: FaTachometerAlt },
    { id: 'availability', label: 'Menu Availability', icon: FaClipboardList },
